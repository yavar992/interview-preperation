...
public class Infosysinterview {
    public static void main(String[] args) {
        ...
        // suppose you have the two interface with the same method now tell me when uh implements the both the interface in a class so what will happended and which one ibterfae wukk e exexuted - java will implements the only methods of both the class , baically java treats them as the same method during the implementation
